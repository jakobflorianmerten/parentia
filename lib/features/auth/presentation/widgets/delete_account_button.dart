      ...
      listener: (context, state) {
        ...
        state.failureOrSuccess.fold(() {}, (v) {
          v.fold((failure) {
            ...
            MessageService.show(context, title: AppLocalizations.of(context)!.success_deleteAccountTitle, message: AppLocalizations.of(context)!.success_deleteAccountDescription, type: MessageType.success);
          });
        });
      },
