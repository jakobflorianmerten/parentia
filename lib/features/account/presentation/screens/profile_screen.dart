                          ...
                          listener: (context, state) {
                            state.failureOrSuccess.fold(() {}, (value) {
                              value.fold((failure) {
                                ...
                                MessageService.show(context, title: AppLocalizations.of(context)!.success_editProfileTitle, message: AppLocalizations.of(context)!.success_editProfileDescription, type: MessageType.success);
                              });
                            });
                          },
                            builder: (context, state) {
