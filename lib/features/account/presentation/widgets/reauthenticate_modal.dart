                ...
                state.failureOrSuccess.fold(() {}, (v) {
                  v.fold((failure) {
                    if (failure is ReauthenticateUserButNoUserLoggedIn) {
                      MessageService.show(context, title: AppLocalizations.of(context)!.error_reauthenticateButNoUserLoggedInTitle, message: AppLocalizations.of(context)!.error_reauthenticateButNoUserLoggedInDescription, type: MessageType.error);
                    } else if (failure is ReauthenticateUserWithDifferentEmail) {
                      MessageService.show(context, title: AppLocalizations.of(context)!.error_reauthenticateWithDifferentEmailTitle, message: AppLocalizations.of(context)!.error_reauthenticateWithDifferentEmailDescription, type: MessageType.error);
                    } else if (failure is ReauthenticateUserMismatch) {
                      MessageService.show(context, title: AppLocalizations.of(context)!.error_reauthenticateUserMismatchTitle, message: AppLocalizations.of(context)!.error_reauthenticateUserMismatchDescription, type: MessageType.error);
                    } else if (failure is ReauthenticateInvalidCredential) {
                      MessageService.show(context, title: AppLocalizations.of(context)!.error_reauthenticateInvalidCredentialTitle, message: AppLocalizations.of(context)!.error_reauthenticateInvalidCredentialDescription, type: MessageType.error);
                    } else {
                    ...
                    MessageService.show(context, title: AppLocalizations.of(context)!.success_reauthenticateSuccessTitle, message: AppLocalizations.of(context)!.success_reauthenticateSuccessDescription, type: MessageType.success);
