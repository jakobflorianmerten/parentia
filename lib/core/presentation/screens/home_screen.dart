                    ...
                    child: CustomScrollView(
                      slivers: [
                        ...
                        state.activeTransactions.length == 0 && state.notActiveTransactions.length == 0
                            ? SliverToBoxAdapter(
                                child: Text(
                                  AppLocalizations.of(context)!.noCurrentTransactions,
                                ),
                              )
                            : SliverToBoxAdapter(),
                        state.activeTransactions.length != 0 ? SliverToBoxAdapter(
                          child: Text(
                            AppLocalizations.of(
                              context,
                        ...
                        state.activeTransactions.length != 0 ? SliverToBoxAdapter(child: addVerticalSpace(15)) : SliverToBoxAdapter(),
                        SliverList.separated(
                          ...
                          itemBuilder: (context, index) =>
                              CurrentTransactionElement(
                                transaction: state.activeTransactions[index],
                              ),
                        ),
                        state.activeTransactions.length != 0 ? SliverToBoxAdapter(child: addVerticalSpace(25)) : SliverToBoxAdapter(),
                        state.notActiveTransactions.length != 0 ? SliverToBoxAdapter(
                          child: Text(
                            AppLocalizations.of(
                              context,
                        ...
                        state.notActiveTransactions.length != 0 ? SliverToBoxAdapter(child: addVerticalSpace(15)) : SliverToBoxAdapter(),
                        SliverList.separated(
